 ...
 */
public class ProgressWheelEx extends View {
  private static final String TAG = ProgressWheelEx.class.getSimpleName();
   ...
   */
  public ProgressWheelEx(Context context, AttributeSet attrs) {
    super(context, attrs);
   ...
   * The constructor for the ProgressWheel
   */
  public ProgressWheelEx(Context context) {
    super(context);
    setAnimationEnabled();
  }
